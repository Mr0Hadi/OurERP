...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260731211720_purchase-receiving-return")]
    partial class purchasereceivingreturn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ReceiptDiscrepancy", b =>
                {
                    ...
                    b.HasIndex("PurchaseReturnItemId")
                        .IsUnique()
                        .HasFilter("[PurchaseReturnItemId] IS NOT NULL");

                    b.ToTable("ReceiptDiscrepancies");
                });

            modelBuilder.Entity("Domain.Entities.ReturnItemDecision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
