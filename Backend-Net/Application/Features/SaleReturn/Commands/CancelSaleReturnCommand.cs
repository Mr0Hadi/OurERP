...
namespace Application.Features.SaleReturn.Commands
{
    ...
    public class CancelSaleReturnCommandHandler : IRequestHandler<CancelSaleReturnCommand, ResponseDto>
    {
        ...
        public CancelSaleReturnCommandHandler(IWMSDbContext context, ISaleReturnQueryService saleReturnQueryService, ISaleReturnCalculationService saleReturnCalculationService, IUnitOfWork unitOfWork)
        {
            _context = context;
