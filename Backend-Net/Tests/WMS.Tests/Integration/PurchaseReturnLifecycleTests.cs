...
namespace WMS.Tests.Integration
{
    public class PurchaseReturnLifecycleTests
    {
        ...
        public async Task AddClaimResolution_MoneyOnly_SettlesImmediatelyAndBumpsSettledQuantity()
        {
            ...
            var handler = new AddClaimResolutionCommandHandler(scope.Db, scope.PurchaseReturnCalculation, scope.UnitOfWork);
        ...
        public async Task AddClaimResolution_MultipleGoodsInProducts_ProducesOneEffectPerProduct()
        {
            ...
            await handler.Handle(new AddClaimResolutionCommand
            {
                ...
                Composition = new EffectCompositionDto
                {
                    ...
                    GoodsIn = new()
                    {
                        new GoodsEffectDto { Quantity = 2 },
                        new GoodsEffectDto { Quantity = 1, ProductId = otherProduct.Id },
                    },
                },
            }, CancellationToken.None);

            using var verify = db.NewContext();
            var effects = verify.PurchaseReturnEffects.ToList();
        ...
        public async Task AddClaimResolution_QuantityExceedsRemaining_Throws()
        {
            ...
            {
                ClaimId = claimId,
                Composition = new EffectCompositionDto { Quantity = 4, GoodsIn = new() { new GoodsEffectDto { Quantity = 4 } } },
            }, CancellationToken.None));
        }
        ...
        public async Task ExecuteGoodsRound_CompletesGoodsInEffect_RestocksAndAppliesAndSettles()
        {
            ...
            var addHandler = new AddClaimResolutionCommandHandler(scope.Db, scope.PurchaseReturnCalculation, scope.UnitOfWork);
            ...
            var roundHandler = new ExecuteGoodsRoundCommandHandler(scope.Db, scope.PurchaseReturnCalculation, scope.ProductUnitService, scope.InventoryCostingService, scope.UnitOfWork);
        ...
        public async Task RemoveClaimResolution_Untouched_Succeeds()
        {
            ...
            var removeHandler = new RemoveClaimResolutionCommandHandler(scope.Db, scope.PurchaseReturnCalculation, scope.UnitOfWork);
        ...
        public async Task RejectThenReopen_GoesBackToOpen()
        {
            ...
            var reopenHandler = new ReopenPurchaseReturnCommandHandler(reopenScope.Db, reopenScope.PurchaseReturnCalculation, reopenScope.UnitOfWork);
