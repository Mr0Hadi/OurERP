...
namespace WMS.Tests.Integration
{
    public class PurchaseCrudTests
    {
        ...
        public async Task CreatePurchase_MapsAllFieldsIncludingItems()
        {
            ...
            var handler = new CreatePurchaseCommandHandler(scope.PurchaseRepository, TestMapper.Instance, scope.UnitOfWork);
        ...
        public async Task UpdatePurchase_UnknownId_ThrowsNotFound()
        {
            ...
            var handler = new UpdatePurchaseCommandHandler(scope.PurchaseRepository, scope.UnitOfWork);
        ...
        public async Task GetPurchaseDetail_ReturnsMappedDto()
        {
            ...
            var handler = new GetPurchaseDetailQueryHandler(scope.Db);
