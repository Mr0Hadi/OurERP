// src/features/warehouse/shipping/components/forms/ShippingTransporterSection.jsx
...
export default function ShippingTransporterSection({
  ...
  const [prevSaleId, setPrevSaleId] = useState(formData.saleId);

  if (formData.saleId !== prevSaleId) {
    setPrevSaleId(formData.saleId);
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                onFormChange({ driverNationalId: onlyDigits(e.target.value, 10) })
              }
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            اگر کالا با پیک یا حضوری تحویل داده می‌شود و پلاکی در کار نیست، این
            بخش را خالی بگذارید.
          </p>
        </div>
