 ...
 *
 * جدا از لایه‌ی سرویس نگه داشته می‌شود چون واژگان به سرور مهاجرت
 * نمی‌کند: کامپوننت‌های جدول باید بتوانند بدونِ وابستگی به پیاده‌سازیِ
 * API از آن بخوانند.
 */
 ...
 *
 * تنها تعریفِ این فهرست — صف و صفحه‌ی جزئیات هر دو از همین می‌خوانند.
 */
