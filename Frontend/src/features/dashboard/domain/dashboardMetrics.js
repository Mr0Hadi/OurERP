 ...
 * می‌خواهند.
 *
 * چرا جدا از لایه‌ی API: لایه‌ی API فقط همان چیزی را می‌دهد که روی سیم
 * می‌آید. هر مشتقی — برچسبِ شمسی، حاشیه‌ی سود، درصدِ رشد — اینجا ساخته
 * می‌شود، تا تغییرِ شکلِ نمودارها به قراردادِ سرور دست نزند.
 */
