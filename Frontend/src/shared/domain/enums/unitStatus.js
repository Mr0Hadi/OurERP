 ...
 * نمی‌آید یا موقع ارسال رد می‌شود، و فقط باعث می‌شود UI حالتی را نشان
 * بدهد که هیچ‌وقت ذخیره نمی‌شود. اگر روزی بکند عضوی اضافه کرد، همین
 * فایل و `UnitStatusBadge` تغییر می‌کنند.
 */
