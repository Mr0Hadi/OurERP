 ...
 *
 * آدرس ثابت است و منقضی نمی‌شود: باکتِ Liara به User-Agentِ مرورگر ۴۰۴
 * می‌دهد، پس هیچ آدرسِ باکتی در `<img>` بار نمی‌شود و سرور خودش بایت‌ها
 * را سرو می‌کند. تنها کارِ این کامپوننت این است که اگر پاسخ فقط
 * `imageKey` داشت، آدرس را یک‌بار از `GetImageUrl` بگیرد.
 */
